...
namespace CommAnalyzer.UserControls
{
    /// <summary>
    /// Lógica de interacción para ipTextBox.xaml
    /// </summary>
     //LINK DE LA CONFIGURACION
    //https://stackoverflow.com/a/35326967
    ...
    public partial class ipTextBox : UserControl
    {
        ...
        private void UIElement_OnPreviewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.OemPeriod || e.Key == Key.Decimal)    //https://stackoverflow.com/q/21435550
            {
                e.Handled = true;
        ...
        private void DataObject_OnPasting(object sender, DataObjectPastingEventArgs e)
        {
            ...
            if (Regex.IsMatch(text, patronIP))
            {
                Address = text;
            }
            else
